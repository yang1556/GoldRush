from grtrader.ProductMgr import ProductInfo
from grtrader.SessionMgr import SessionInfo
from grtrader.ContractMgr import ContractInfo
from grtrader.GrtDataDefs import GrtNpTicks, GrtNpKline
...
class CtaContext:
    ...
    def on_getticks(self, stdCode:str, newTicks:GrtNpTicks):
        key = stdCode
    ...
    def on_getbars(self, stdCode:str, period:str, npBars:GrtNpKline):
    ...
    def on_tick(self, stdCode:str, newTick:POINTER(GRTSTickStruct)):
        '''
        tick回调事件响应
        '''
        self.__stra_info__.on_tick(self, stdCode, newTick.contents.to_dict)

    def on_bar(self, stdCode:str, period:str, newBar:POINTER(GRTSBarStruct)):
        '''
        K线闭合事件响应
        @stdCode   品种代码
        @period     K线基础周期
    ...
    def stra_get_bars(self, stdCode:str, period:str, count:int, isMain:bool = False) -> GrtNpKline:
        '''
        获取历史K线
        @stdCode   合约代码
        @period K线周期, 如m3/d7
    ...
    def stra_get_ticks(self, stdCode:str, count:int) -> GrtNpTicks:
        '''
        获取tick数据
        @stdCode   合约代码
        @count  要拉取的tick数量
