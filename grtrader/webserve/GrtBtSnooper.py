...
class GrtBtSnooper:
    ...
    def get_bt_kline(self, path:str, straid:str) -> list:
        ...
        if barList is None:
            return None
        #print(barList.days[0])
        # print(barList.bartimes[0])
        # print(barList.opens[0])
        # print(barList.highs[0])
        # print(barList.lows[0])
        # print(barList.closes[0])
        # print(barList.volumes[0])
        #print(barList.moneys[0])
