...
if __name__ == '__main__':
    ...
    ts.set_token('c7ddfed8d03061069679f32609cabdcfb3d237a1442146920a519524')
    pro = ts.pro_api()
    ...
    # 建立数据库连接,剔除已入库的部分
    db = pymysql.connect(host='124.71.219.185', user='root', passwd='uestc2022!', db='grtdata', charset='utf8')
    cursor = db.cursor()
    # 设定需要获取数据的股票池
    stock_pool = ['300666.SZ','300618.SZ']
    #stock_pool = ['603912.SH']
    ...
    for i in range(len(stock_pool)):
        ...
        for j in range(c_len):
            ...
            try:
                ...
                #sql_select = "select * from stock_all"
